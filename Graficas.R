...
del_b <- del_b %>%
  group_by(muni) %>% 
  mutate(
    total_lag = lag(total, n=1, order_by = muniYear),
    ...
    perftot = ((total - total_lag)/total_lag) * 100, 
...
zden_del <- ggarrange(zpdt, zpdd, zpds, zpdh, zpdl, zpdr, zpdo, label.y = "", align = "h")
...
##scatter de del_b
zsd1 <- ggplot(data = subset(del_b, !is.na(alt)), aes(x = year, y = perftot, col = factor(alt))) +
...
zsd4 <- ggplot(data = subset(del_b, !is.na(alt)), aes(x = year, y = perfhom, col = factor(alt))) +
  geom_point(alpha = 0.2, position = "jitter") +
  scale_x_continuous(breaks = seq(from = 1994, to = 2010, by = 1)) + 
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
  labs(y = "Homicidios", col = "Alt")
...
zscat_del <- ggarrange(zsd1,zsd2,zsd3,zsd4,zsd5,zsd6,zsd7)
...
xden_serv <- ggarrange(xpda, xpde, xpdj, xpdp, xpddr)
...
##Scatters de serv_b
xss1 <- ggplot(data = subset(serv_b, !is.na(alt)), aes(x = year, y = perf_agua)) +
  geom_point(aes(colour = factor(alt)), alpha = 0.2, position = "jitter") + 
  scale_x_continuous(breaks = seq(from = 1994, to = 2015, by = 1)) + 
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
  labs(y = "Agua", colour = "Alt")

xss2 <- ggplot(data = subset(serv_b, !is.na(alt)), aes(x = year, y = perf_elec)) +
  geom_point(aes(colour = factor(alt)), alpha = 0.2, position = "jitter") + 
  scale_x_continuous(breaks = seq(from = 1994, to = 2015, by = 1)) + 
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
  labs(y = "Electricidad", colour = "Alt")
...
xss5 <- ggplot(data = subset(serv_b, !is.na(alt)), aes(x = year, y = perf_sist_dren)) +
  geom_point(aes(colour = factor(alt)), alpha = 0.2, position = "jitter") + 
  scale_x_continuous(breaks = seq(from = 1994, to = 2015, by = 1)) + 
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
  labs(y = "Drenaje", colour = "Alt")

xscat_serv <- ggarrange(xss1, xss2, xss3, xss4, xss5)
...
yseds1 <- ggplot(data = subset(serv_b, !is.na(alt)), aes(x = year, y = perfmayor6_leer_esc)) +
  geom_point(aes(colour = factor(alt)), alpha = 0.2, position = "jitter") + 
  scale_x_continuous(breaks = seq(from = 1994, to = 2015, by = 1)) + 
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
  labs(y = "Alfabetizada \n (> 6 anios)", colour = "Alt")

yseds2 <- ggplot(data = subset(serv_b, !is.na(alt)), aes(x = year, y = perfmay5_asistencia)) +
  geom_point(aes(colour = factor(alt)), alpha = 0.2, position = "jitter") + 
  scale_x_continuous(breaks = seq(from = 1994, to = 2015, by = 1)) + 
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
  labs(y = "Asistencia \n (> 5 anios)", colour = "Alt")
...
####Boxplot cambio %####
#del_b
#zbpd1a <- ggplot(data = subset(del_b, !is.na(alt) & !is.na(inc_top) & perftot < 120 & perftot > -100)) +  geom_boxplot(aes(x = factor(alt), y = perftot)) +  scale_y_continuous(breaks = seq(-100 , 120, by = 10)) +  labs(x = "Alt", y = "Total", title = "Alternancia y cambio porcentual de bienes publicos", subtitle = "Delitos registrados ante el MP", caption = "Diferencial entre el año electoral t-1 y t")ggsave("zbp_td.png", path = out, dpi = 320)

#try1 <- ggplot(data = subset(del_b, !is.na(alt) & !is.na(inc_top) & perftot < 130 & perftot != -100)) +  geom_boxplot(aes(x = factor(alt), y = perftot)) +  scale_y_continuous(breaks = seq(-100 , 120, by = 10)) +  labs(x = "Alt", y = "Total", title = "Alternancia y cambio en bienes por estado", subtitle = "Delitos registrados ante el MP", caption = "Diferencial entre el año electoral t-1 y t") +  facet_grid(win_top ~ state)

zbpd1 <- ggplot(data = subset(del_b, !is.na(alt) & !is.na(inc_top) & perftot < 200 & perftot != -100)) +#& perftot <= quantile(perftot, 0.85, na.rm = T))) + #Esto nos dice que aprox el 15% de las observaciones son outliers
...
zbpd2 <- ggplot(data = subset(del_b, !is.na(alt) & !is.na(inc_top) & perfdanio < 200 & perfdanio != -100)) +
...
zbpd3 <- ggplot(data = subset(del_b, !is.na(alt) & !is.na(inc_top) & perfdelsex < 200 & perfdelsex != -100)) +
...
zbpd4 <- ggplot(data = subset(del_b, !is.na(alt) & !is.na(inc_top) & perfhom < 200 & perfhom != -100)) +
...
zbpd5 <- ggplot(data = subset(del_b, !is.na(alt) & !is.na(inc_top) & perfles < 200 & perfles != -100)) +
...
zbpd6 <- ggplot(data = subset(del_b, !is.na(alt) & !is.na(inc_top) & perfrobo < 200 & perfrobo != -100)) +
...
zbpd7 <- ggplot(data = subset(del_b, !is.na(alt) & !is.na(inc_top) & perfotros < 200 & perfotros != -100)) +
...
xbps1 <- ggplot(data = subset(serv_b, !is.na(alt) & !is.na(inc_top) & perf_agua <= quantile(perf_agua, 0.9, na.rm = T) & perf_agua != -100)) +
  geom_boxplot(aes(x = factor(alt), y = perf_agua)) +
...
xbps2 <- ggplot(data = subset(serv_b, !is.na(alt) & !is.na(inc_top) & perf_elec <= quantile(perf_elec, 0.9, na.rm = T) & perf_elec != -100)) +
  geom_boxplot(aes(x = factor(alt), y = perf_elec)) +
  scale_y_continuous(breaks = seq(-100 , 50, by = 10)) +
  labs(x = "Alt", y = "Electricidad", title = "Alternancia y cambio en bienes por partido", subtitle = "Servicios publicos", caption = "Diferencial entre el año electoral t-1 y t") +
  facet_grid(. ~ inc_top)
...
xbps4 <- ggplot(data = subset(serv_b, !is.na(alt) & !is.na(inc_top) & perf_parques < 50 & perf_parques != -100)) +
  geom_boxplot(aes(x = factor(alt), y = perf_parques)) +
  scale_y_continuous(breaks = seq(-100 , 50, by = 10)) +
  labs(x = "Alt", y = "Parques", title = "Alternancia y cambio en bienes por partido", subtitle = "Servicios publicos", caption = "Diferencial entre el año electoral t-1 y t") +
  facet_grid(. ~ inc_top)
...
xbps5 <- ggplot(data = subset(serv_b, !is.na(alt) & !is.na(inc_top) & perf_sist_dren <= quantile(perf_sist_dren, 0.9, na.rm = T) & perf_sist_dren != -100)) +
  geom_boxplot(aes(x = factor(alt), y = perf_sist_dren)) +
  labs(x = "Alt", y = "Drenaje", title = "Alternancia y cambio en bienes por partido", subtitle = "Servicios publicos", caption = "Diferencial entre el año electoral t-1 y t") +
  facet_grid(. ~ inc_top)
ggsave("xbp_sist_dren_ser.png", path = out, dpi = 320)

ybped1 <- ggplot(data = subset(serv_b, !is.na(alt) & !is.na(inc_top) & perfmayor6_leer_esc <= quantile(perfmayor6_leer_esc, 0.9, na.rm = T) & perfmayor6_leer_esc != -100)) +
  geom_boxplot(aes(x = factor(alt), y = perfmayor6_leer_esc)) +
  labs(x = "Alt", y = "Alfabetizacion", title = "Alternancia y cambio en bienes por partido", subtitle = "Educacion", caption = "Diferencial entre el año electoral t-1 y t") +
  facet_grid(. ~ inc_top)
ggsave("ybp_mayor6_leer_escetizacion_edu.png", path = out, dpi = 320)

ybped2 <- ggplot(data = subset(serv_b, !is.na(alt) & !is.na(inc_top) & perfmay5_asistencia <= quantile(perfmay5_asistencia, 0.9, na.rm = T) & perfmay5_asistencia != -100)) +
  geom_boxplot(aes(x = factor(alt), y = perfmay5_asistencia)) +
  labs(x = "Alt", y = "Asistencia", title = "Alternancia y cambio en bienes por partido", subtitle = "Educacion", caption = "Diferencial entre el año electoral t-1 y t") +
  facet_grid(. ~ inc_top)
ggsave("ybp_may5_asistenciaencia_edu.png", path = out, dpi = 320)

ybped3 <- ggplot(data = subset(serv_b, !is.na(alt) & !is.na(inc_top) & perfmay5_nivel <= quantile(perfmay5_nivel, 0.9, na.rm = T) & perfmay5_nivel != -100)) +
...
ybped5 <- ggplot(data = subset(serv_b, !is.na(alt) & !is.na(inc_top) & perfmay18_posg <= quantile(perfmay18_posg, 0.9, na.rm = T) & perfmay18_posg != -100)) +
  geom_boxplot(aes(x = factor(alt), y = perfmay18_posg)) +
  labs(x = "Alt", y = "Posgrado", title = "Alternancia y cambio en bienes por partido", subtitle = "Educacion", caption = "Diferencial entre el año electoral t-1 y t") +
  facet_grid(. ~ inc_top)
ggsave("ybp_may18_posgrado_edu.png", path = out, dpi = 320)

ybped6 <- ggplot(data = subset(serv_b, !is.na(alt) & !is.na(inc_top) & perfmay15_escol_mean <= quantile(perfmay15_escol_mean, 0.9, na.rm = T) & perfmay15_escol_mean != -100)) +
  geom_boxplot(aes(x = factor(alt), y = perfmay15_escol_mean)) +
  labs(x = "Alt", y = "Escol prom", title = "Alternancia y cambio en bienes por partido", subtitle = "Educacion", caption = "Diferencial entre el año electoral t-1 y t") +
  facet_grid(. ~ inc_top)
ggsave("ybp_escolaridad_promedio_edu.png", path = out, dpi = 320)

ybped7 <- ggplot(data = subset(serv_b, !is.na(alt) & !is.na(inc_top) & perfmay5_indigena <= quantile(perfmay5_indigena, 0.9, na.rm = T) & perfmay5_indigena != -100)) +
